...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener('click', function(e) {
            ...
            const originalDownloadDisplay = downloadSection ? downloadSection.style.display : '';
            ...
            const printOptions = {
                margin: [10, 10, 10, 10],
                filename: 'Resume_BCA_Student.pdf',
            ...
            // Alternative: If you want to use html2pdf library (recommended)
            // html2pdf().from(document.body).set(printOptions).save();
            
            // Restore original display values after print dialog
            setTimeout(() => {
                if (navbar) navbar.style.display = originalNavDisplay;
                if (footer) footer.style.display = originalFooterDisplay;
                if (downloadSection) downloadSection.style.display = originalDownloadDisplay;
            }, 1000);
